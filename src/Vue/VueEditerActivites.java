...
public class VueEditerActivites extends JDialog implements ActionListener, WindowListener, MouseListener{
	...
	//---------------------Constructeurs---------------------------
	/**
	 *Nom: VueEditerActivites
	 *Description: permet de créer la fenêtre d'édition Entraînements/Events Ponctuels
	 *Entrée: fenêtre parent, titre de la fenetre, controleur, type d'Activité
	 *Sortie: 
	 *Retour: fenetre initialisée
	...
	/**
	 *Nom: majActivite
	 *Description: permet d'afficher les informations relatives à une activité
	 *Entrée: -
	 *Sortie: -
	 *Retour: -
	 *Précondition: -
